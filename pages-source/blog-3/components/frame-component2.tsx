...
const MORE_BLOGS = [
  ...
  },
  {
    ...
    excerpt: "Research shows the first five years are the most critical window for development. Aspire Rwanda's nursery programme is designed to make every one of those years count.",
    href: "/blog-2",
  },
  {
    category: "Skills",
