      ...
      <div className={styles.rectangleParent}>
        ...
        <section className={styles.testimonialInfo}>
          ...
          <div className={styles.asAMother}>
            What started as a small opportunity has completely changed my path.
            Today, I am building a future I never thought possible.
          </div>
          <Link href="/story-2" className={styles.testimonialAction}>
