        ...
        <div className={styles.ourProjectsTwoCol}>
          <div className={styles.ourProjectsLeft}>
            ...
            <div className={styles.ourProjectsExplore}>
              Explore Aspire Rwanda&apos;s focused projects that equip children and youth from poor families with practical <br />skills, and the confidence to shape their future.
            </div>
